...
<div <?php Functions::listing_class( [ 'rtcl-widget-listing-item', $item_class, 'listing-item', $img_position_class ] ); ?>>
	...
	if ( $phone && $instance['rtcl_show_phone'] ) :
		...
		<div class="rtin-phn rtin-el-button">
			<a class="rtcl-phone-reveal not-revealed" href="#"
				data-phone="<?php echo esc_attr( $phone ); ?>"><i class="rtcl-icon rtcl-icon-phone" aria-hidden="true"></i><span><?php esc_html_e( 'Show Phone No', 'rtcl-elementor-builder' ); ?></span></a>
		</div>
	<?php endif; ?>
	...
	if ( rtcl()->has_pro() ) {
		if ( ! empty( $instance['rtcl_show_quick_view'] ) ) :
			...
			<div class="rtin-el-button">
				<a class="rtcl-quick-view" href="#"
					title="<?php esc_attr_e( 'Quick View', 'rtcl-elementor-builder' ); ?>"
		...
		if ( ! empty( $instance['rtcl_show_compare'] ) ) :
			...
			<div class="rtin-el-button">
				...
				<a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#"
					title="<?php esc_attr_e( 'Compare', 'rtcl-elementor-builder' ); ?>"
					data-listing_id="<?php echo absint( $_id ); ?>">
